...
const std::string kObjectsName = "/carla/ego_vehicle/objects";                                             //NOLINT
const std::string kPublishedTrajectoryName = "/behaviour_planner/published_trajectory";                    //NOLINT
...
const std::string kVisualizedValidTrajectoriesName = "/behaviour_planner/visualized_valid_trajectories";   //NOLINT
...
const std::string kVisualizedTrafficLightBoxName = "/behaviour_planner/visualized_traffic_light_boxes";    //NOLINT
const std::string kVisualizedReferenceLinesName = "/behaviour_planner/visualized_reference_lines";         //NOLINT
const std::string kVisualizedRouteName = "/behaviour_planner/visualized_route";                            //NOLINT
}
