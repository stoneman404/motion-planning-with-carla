#ifndef CATKIN_WS_SRC_MOTION_PLANNING_WITH_CARLA_BEHAVIOUR_PLANNING_SRC_PLANNING_CONTEXT_HPP_
#define CATKIN_WS_SRC_MOTION_PLANNING_WITH_CARLA_BEHAVIOUR_PLANNING_SRC_PLANNING_CONTEXT_HPP_
...
class PlanningContext {
 public:
   ...
   * @return
   */
  std::list<planning_srvs::RoutePlanServiceResponse> &mutable_route_infos();
   ...
   * @return
   */
  const std::list<planning_srvs::RoutePlanServiceResponse> &route_infos() const;
 ...
 private:
  ...
  std::list<planning_srvs::RoutePlanServiceResponse> route_infos_{};
