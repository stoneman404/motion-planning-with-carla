...
const std::list<planning_srvs::RoutePlanServiceResponse> &PlanningContext::route_infos() const {
  return route_infos_;
}
...
std::list<planning_srvs::RoutePlanServiceResponse> &PlanningContext::mutable_route_infos() { return route_infos_; }
}