#ifndef CATKIN_WS_SRC_MOTION_PLANNING_WITH_CARLA_BEHAVIOUR_PLANNING_SRC_PLANNER_HPP_
#define CATKIN_WS_SRC_MOTION_PLANNING_WITH_CARLA_BEHAVIOUR_PLANNING_SRC_PLANNER_HPP_
#include <ros/ros.h>
...
#include <planning_srvs/RoutePlanServiceResponse.h>
...
class Planner {
 ...
 private:
  ...
  void VisualizeRoute(std::vector<planning_srvs::RoutePlanServiceResponse> &route);
 ...
 private:
  ...
  ros::Publisher visualized_route_publisher_;

  //////////////////////behaviour planner///////////////
  std::unique_ptr<BehaviourPlanner> behaviour_planner_;
  /////////////////// thread pool///////////////////
