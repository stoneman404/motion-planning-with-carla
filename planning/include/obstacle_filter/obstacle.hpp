...
#ifndef CATKIN_WS_SRC_PLANNING_INCLUDE_OBSTACLE_FILTER_OBSTACLE_HPP_
#define CATKIN_WS_SRC_PLANNING_INCLUDE_OBSTACLE_FILTER_OBSTACLE_HPP_
#include <list>
#include <memory>
...
#endif //CATKIN_WS_SRC_PLANNING_INCLUDE_OBSTACLE_FILTER_OBSTACLE_HPP_
