...
ReferenceLineSmoothIpoptInterface::ReferenceLineSmoothIpoptInterface(const planning::ReferenceLine &raw_ref) {
  ...
  curvature_weight_ = PlanningConfig::Instance().reference_smoother_curvature_weight();
  heading_weight_ = PlanningConfig::Instance().reference_smoother_heading_weight();
  length_weight_ = PlanningConfig::Instance().reference_smoother_distance_weight();
  ref_deviation_weight_ = PlanningConfig::Instance().reference_smoother_deviation_weight();
  max_curvature_ = PlanningConfig::Instance().reference_smoother_max_curvature();
