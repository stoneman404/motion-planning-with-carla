#ifndef CATKIN_WS_SRC_PLANNING_MATH_INCLUDE_MATH_UTILS_HPP_
#define CATKIN_WS_SRC_PLANNING_MATH_INCLUDE_MATH_UTILS_HPP_
...
#endif //CATKIN_WS_SRC_PLANNING_MATH_INCLUDE_MATH_UTILS_HPP_